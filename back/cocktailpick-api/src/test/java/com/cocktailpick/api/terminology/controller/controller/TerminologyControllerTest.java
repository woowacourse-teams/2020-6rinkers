package com.cocktailpick.api.terminology.controller.controller;
...
import com.cocktailpick.api.terminology.controller.TerminologyController;
import com.cocktailpick.api.terminology.controller.docs.TerminologyDocumentation;
	...
	void saveTerminologiesByCsv() throws Exception {
		...
		mockMvc.perform(multipart("/api/terminologies/upload/csv")
			.file(new MockMultipartFile("file", "test.csv", "text/csv",
				Fixtures.FOUR_TERMINOLOGIES_CSV_CONTENT.getBytes()))
			.header("authorization", "Bearer ADMIN_TOKEN")
