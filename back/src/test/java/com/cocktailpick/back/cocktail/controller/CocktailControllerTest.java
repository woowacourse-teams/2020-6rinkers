	...
	void addCocktailsByCsv() throws Exception {
		String content =
			"name,abv,description,origin,imageUrl,tag,sweet,sour,bitter,liquor,liquorQuantity,oz,special,specialQuantity,from,\n"
				+ "갓마더,30,갓파더에서 위스키 대신 보드카를 사용한 칵테일입니다.,God Mother 대모라는 뜻입니다.,\"https://images.cocktailflow.com/v1/cocktail/w_300,h_540/cocktail_god_mother-1.png\",\"아몬드,부드러움\",1,,1,보드카,45,1.5,,,http://www.flickriver.com/photos/31027007@N08/31782815995/,\n"
				+ ",,,,,,,,,아마레또,30,1,,,,\n"
				+ "갓파더,39,\"베이스로 스카치 위스키를 사용합니다. 기주를 보드카로 바꾸면 '갓마더'로, 브랜디(코냑)로 바꾸면 '프렌치 커넥션'이 됩니다.\",영화 '대부'에서 비토 콜레오네(말론 브란도 역)가 마신 칵테일입니다.,https://s7d9.scene7.com/is/image/SAQ/godfather-ec?$saq-fiche-cocktail$,아몬드,1,,1,위스키,45,1.5,,,http://www.flickriver.com/search/godfather+cocktail/,\n"
				+ ",,,,,,,,,아마레또,22.5,0.75,,,,\n"
				+ "그래스호퍼,15,\"크림을 사용하고, 녹색빛을 띄고 있는 민트향 칵테일입니다.\",칵테일의 색이 녹색이어서 메뚜기라는 이름이 붙었습니다.,https://banner2.kisspng.com/20180221/qde/kisspng-cocktail-sidecar-gimlet-martini-grasshopper-cocktail-5a8defe0899285.9571797915192514245635.jpg,\"민트,초코,부드러움\",1,1,,크렘 드 멘트,30,1,,,http://www.flickriver.com/search/grasshopper+cocktail/,\n"
				+ ",,,,,,,,,크렘 드 카카오,30,1,,,,\n"
				+ ",,,,,,,,,우유,30,1,,,,";
