...
import com.cocktailpick.core.tag.domain.CocktailTags;
...
public class Cocktail extends BaseTimeEntity {
	...
	@Embedded
	private final CocktailTags cocktailTags = CocktailTags.empty();

	@Embedded
	private Flavor flavor;

	@Embedded
	private final Recipe recipe = Recipe.empty();
