...
import static com.cocktailpick.api.tag.acceptance.step.TagAcceptanceStep.*;
import static com.cocktailpick.api.user.acceptance.step.AuthAcceptanceStep.*;
import static com.cocktailpick.core.cocktail.vo.UserPreferenceAnswer.*;
...
public class CocktailAcceptanceTest extends AcceptanceTest {
	...
	void addCocktail() {
		...
		// when
		ExtractableResponse<Response> response = requestToAddCocktail(
			KAHLUA_MILK_REQUEST, authResponse);
