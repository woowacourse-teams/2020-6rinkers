...
import com.cocktailpick.api.WithMockCustomUser;
import com.cocktailpick.api.cocktail.dto.CocktailResponse;
import com.cocktailpick.api.common.documentation.DocumentationWithSecurity;
import com.cocktailpick.api.favorite.dto.FavoriteRequest;
import com.cocktailpick.api.tag.dto.TagResponse;
import com.cocktailpick.api.user.api.UserController;
import com.cocktailpick.api.user.docs.UserDocumentation;
import com.cocktailpick.api.user.dto.FavoriteCocktailIdsResponse;
import com.cocktailpick.api.user.dto.UserUpdateRequest;
import com.cocktailpick.api.user.service.UserService;
...
class UserControllerTest extends DocumentationWithSecurity {
	...
	void findFavorites() throws Exception {
		...
		mockMvc.perform(RestDocumentationRequestBuilders.get("/api/user/me/favorites")
	...
	void findFavoriteCocktailIdsTest() throws Exception {
		...
		mockMvc.perform(RestDocumentationRequestBuilders.get("/api/user/me/favoriteIds").accept(MediaType.APPLICATION_JSON)
	...
	void addFavorite() throws Exception {
		...
		mockMvc.perform(RestDocumentationRequestBuilders.post("/api/user/me/favorites")
	...
	void deleteFavorite() throws Exception {
		...
		mockMvc.perform(RestDocumentationRequestBuilders.delete("/api/user/me/favorites?cocktailId={cocktailId}", 1L))
	...
	void updateCurrentUser() throws Exception {
		...
		mockMvc.perform(RestDocumentationRequestBuilders.patch("/api/user/me")
	...
	void deleteCurrentUser() throws Exception {
		...
		mockMvc.perform(RestDocumentationRequestBuilders.delete("/api/user/me")
			.header("authorization", "Bearer ADMIN_TOKEN"))
			.andExpect(status().isNoContent())
			.andDo(print())
